...
$thumb_width = ($options['thumb_width'])?$options['thumb_width']:2560;
...
<div class="main_slider">
	...
	$txt_big = ($list[$i]['wr_1'])?$list[$i]['wr_1']:'IMAGE';
	$txt_small = ($list[$i]['wr_2'])?$list[$i]['wr_2']:'쉽게 관리하는 배너스킨';

	$list[$i]['href'] = ($list[$i]['wr_link1'])?$list[$i]['wr_link1']:$list[$i]['href'];

    ?>
	<div class="slide" style="background:#1f202a url(<?php echo $img;?>) no-repeat 100% 0;">
		<div class="wrap">
			<div class="txt_box">
	...
	if (count($list) == 0) { //게시물이 없을 때
		for ($i=1; $i<=3; $i++) {
	?>
	<div class="slide" style="background:#1f202a url(<?php echo $latest_skin_url;?>/img/bg_visual_0<?php echo $i;?>.jpg) no-repeat 100% 0;">
		<div class="wrap">
			<div class="txt_box">
