...
<div id="bo_list">
    <?php if ( $category_option ) { ?>
        ...
        <nav id="bo_cate">
            <h2>
                <?php echo $qaconfig[ 'qa_title' ] ?> 카테고리
            </h2>
            <ul id="bo_cate_ul">
    ...
    <div class="bo_btn_wr">
        <?php if ( $admin_href || $write_href ) { ?>
            <ul class="bo_btn">
                <?php if ( $admin_href ) { ?>
                    <li><a href="<?php echo $admin_href ?>" class="admin"><i class="fa fa-user-circle"
                                aria-hidden="true"></i><span class="sound_only">관리자</span></a></li>
                <?php } ?>
                <?php if ( $write_href ) { ?>
                    <li><a href="<?php echo $write_href ?>"><i class="fa fa-pencil" aria-hidden="true"></i> <span
                                class="sound_only">문의등록</span></a></li>
                <?php } ?>
            </ul>
        <?php } ?>
        ...
        <fieldset id="bo_sch">
            ...
            <form name="fsearch" method="get">
                ...
                <input type="text" name="stx" value="<?php echo stripslashes( $stx ) ?>" required id="stx"
                    class="sch_input required" size="15" maxlength="15">
        ...
        <div class="list_01">
            <ul>
                ...
                for ( $i = 0; $i < count( $list ); $i++ ) {
                    ?>
                    <li class="bo_li<?php if ( $is_checkbox )
                        echo ' bo_adm'; ?>">
                        <?php if ( $is_checkbox ) { ?>
