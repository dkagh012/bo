...
<? 
$reple_href = './good.php?bo_table='.$bo_table.'&amp;wr_id='.$list[$i]['wr_id'].'&amp;good=good';
?>
<a href="<?php echo $reple_href.'&amp;'.$qstr ?>" id="regood_button" class="bo_vc_pick" > 좋아요 
<strong><?php echo number_format($list[$i]['wr_good']) ?></strong></a>
<span id="bo_rev_act_good"></span>
