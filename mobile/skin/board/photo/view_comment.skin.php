...
<button type="button" class="cmt_btn">
  <span class="total">댓글 <strong>
      <?php echo $view[ 'wr_comment' ]; ?>
    </strong></span>
  ...
  <aside id="bo_vc_w" class="bo_vc_w">
    ...
    <form name="fviewcomment" id="fviewcomment" action="<?php echo $comment_action_url; ?>"
      ...
      <div class="bo_vc_w_wr">
        ...
        <button type="submit" id="btn_submit" class="btn btn_cmt_submit">등록</button>
      </div>
...
<section id="bo_vc">
  ...
  for ( $i = 0; $i < $cmt_amt; $i++ ) {
    ...
    */
    ...
    <article id="c_<?php echo $comment_id ?>" <?php if ( $cmt_depth ) { ?>style="margin-left:<?php echo $cmt_depth; ?>px;"
      <?php } ?>>
      <div class="pf_img">
      ...
      <div class="cm_wrap">
        <header style="z-index:<?php echo $cmt_sv; ?>">
          <h2>
            <?php echo get_text( $list[ $i ][ 'wr_name' ] ); ?>님의
            <?php if ( $cmt_depth ) { ?><span class="sound_only">댓글의</span>
            <?php } ?> 댓글
          </h2>
          ...
          <span class="bo_vc_hdinfo">작성일 : <time
            ...
            <ul class="bo_vc_act">
              <li>
                <a class="btn_b03"
                  ...
                  <i class="fa fa-thumbs-up"> </i><strong style="margin-left:10px">
              ...
              <li>
                <a class="btn_b03"
                  href="<?php echo G5_BBS_URL . '/good.php?bo_table=' . $bo_table . '&wr_id=' . $list[ $i ][ 'wr_id' ] . '&good=nogood'; ?>">
                  <i class="fa fa-thumbs-down"> </i><strong style="margin-left:10px">
  ...
  <?php } ?>
  <?php if ( $i == 0 ) { //댓글이 없다면 ?><p id="bo_vc_empty">등록된 댓글이 없습니다.</p>
  <?php } ?>
