...
<button type="button" class="cmt_btn">
	<span class="total">댓글 <strong><?php echo $view['wr_comment']; ?></strong></span>
...
<aside id="bo_vc_w" class="bo_vc_w">
	...
	<?php if ($comment_min || $comment_max) { ?><strong id="char_cnt"><span id="char_count">0</span>/<?php echo $comment_max; ?></strong><?php } ?>
...
<section id="bo_vc">
	...
	<p>
		<?php if (strstr($list[$i]['wr_option'], "secret")) { ?><i class="xi-lock xi-x"></i><?php } ?>
		<?php echo $comment ?>
	</p>
	...
	<?php if($is_comment_reply_edit) { ?>
	<div class="bo_vl_opt">
		<button type="button" class="btn_cm_opt">
