...
<div class="bo_w_select write_div">
	...
	<span class="select">
	<label for="select_label"><?php if($write['ca_name']) { echo $write['ca_name']; } else { echo '카테고리선택'; } ?></label>
...
<div class="bo_w_info write_div">
	...
	<input type="text" name="wr_homepage" value="<?php echo $homepage ?>" id="wr_homepage" class="frm_input" placeholder="홈페이지">
</div>
<?php } ?>
...
<div class="bo_w_tit write_div">
	...
	<div id="autosave_wrapper">
		...
		<?php if ($is_member) { // 임시 저장된 글 기능 ?>
            ...
            <button type="button" id="btn_autosave" class="btn btn_frmline">임시 저장된 글 (<span id="autosave_count"><?php echo $autosave_count; ?></span>)</button>
            <div id="autosave_pop">
...
<div class="write_div bo_w_content">
...
<div class="bo_w_link write_div">
	...
	<input type="text" name="wr_link<?php echo $i ?>" value="<?php if($w=="u"){echo$write['wr_link'.$i];} ?>" id="wr_link<?php echo $i ?>" class="frm_input" placeholder="링크">
</div>
<?php } ?>
...
<div class="bo_w_flie write_div">
	...
	<div class="file_wr">
		<label for="bf_file_<?php echo $i+1 ?>">첨부파일
		<input type="file" name="bf_file[]" id="bf_file_<?php echo $i+1 ?>" title="파일첨부 <?php echo $i+1 ?> : 용량 <?php echo $upload_max_filesize ?> 이하만 업로드 가능" class="frm_file" onchange="javascript:document.getElementById('bf_addfile_<?php echo $i+1 ?>').value=this.value">
		</label>
	...
	<?php if ($is_file_content) { ?>
		<input type="text" name="bf_content[]" value="<?php echo ($w == 'u') ? $file[$i]['bf_content'] : ''; ?>" title="파일 설명을 입력해주세요." class="frm_input" placeholder="파일 설명을 입력해주세요.">
	<?php } ?>

	<?php if($w == 'u' && $file[$i]['file']) { ?>
	<span class="file_del chk_box">
		<input type="checkbox" id="bf_file_del<?php echo $i ?>" name="bf_file_del[<?php echo $i;  ?>]" value="1" class="selec_chk">
		<label for="bf_file_del<?php echo $i ?>"><span></span><?php echo $file[$i]['source'].'('.$file[$i]['size'].')';  ?>파일 삭제</label>
	</span>
	<?php } ?>
...
<div class="btn_confirm">
	<button type="submit" id="btn_submit" accesskey="s" class="btn btn_submit">작성완료</button>
