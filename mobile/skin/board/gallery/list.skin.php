...
<div id="bo_gall">
    ...
    <div class="board_wr">
        <button type="button" class="btn_bosch_op"><i class="fa fa-search"></i><span
        ...
        <fieldset id="bo_sch">
            ...
            <form name="fsearch" method="get">
                ...
                <input name="stx" value="<?php echo stripslashes($stx) ?>" placeholder="검색어(필수)" required id="stx"
            ...
            <button type="button" class="btn_close"><span class="sound_only">다기</span><i class="fa fa-times-circle"></i>
            </button>
        </fieldset>
        ...
        <form name="fboardlist" id="fboardlist" action="<?php echo G5_BBS_URL; ?>/board_list_update.php"
            ...
            <ul class="bo_btn">
                <?php if ($admin_href) { ?>
                    <li><a href="<?php echo $admin_href ?>" class="btn_admin"><i class="fa fa-cog"
                                aria-hidden="true"></i><span class="sound_only">관리자</span></a></li>
                <?php } ?>
                <?php if ($rss_href) { ?><li><a href="<?php echo $rss_href ?>" class=""><i class="fa fa-rss"
                                aria-hidden="true"></i><span class="sound_only">RSS</span></a></li>
                <?php } ?>
                <?php if ($write_href) { ?><li><a href="<?php echo $write_href ?>" class=""><i class="fa fa-pencil"
                                aria-hidden="true"></i><span class="sound_only">글쓰기</span></a></li>
                <?php } ?>
                <?php if ($is_checkbox) { ?>
                    <li><button type="button" class="edit_op_btn view_op_btn_list"><i class="fa fa-ellipsis-v"
                                aria-hidden="true"></i><span class="sound_only">게시판 리스트수정</span></button>
                        <ul class="btn_edit btn_list_op">
                            <li><button type="submit" name="btn_submit" value="선택삭제"
                                    onclick="document.pressed=this.value"><i class="fa fa-trash-o"></i>선택삭제</button></li>
                            <li><button type="submit" name="btn_submit" value="선택복사"
                                    onclick="document.pressed=this.value"><i class="fa fa-files-o"></i>선택복사</button></li>
                            <li><button type="submit" name="btn_submit" value="선택이동"
                                    onclick="document.pressed=this.value"><i class="fa fa-arrows"></i>선택이동</button></li>
                        </ul>
                    </li>
                <?php } ?>
            </ul>
                        ...
                        <div class="gall_li_wr">
                            ...
                            <a href="<?php echo $list[$i]['href'] ?>" class="gall_img">
                                ...
                                if ($list[$i]['is_notice']) { // 공지사항 ?>
                                    <strong
                                        style="width:<?php echo $board['bo_mobile_gallery_width'] ?>px;height:<?php echo $board['bo_mobile_gallery_height'] ?>px">공지</strong>
                                    <?php
                                } else {
                                ...
                                ?>
                                <?php if ($is_good) { ?><strong class="gd_rc"><span class="sound_only">추천</span><i
                            ...
                            <div class="gall_text_href">
                                ...
                                <div class="gall_info">
                                    ...
                                    <span class="sound_only">작성일 </span><span class="date"><i class="fa fa-clock-o"
